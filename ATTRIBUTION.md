...
Dungeons & Dolphins implements compact tracking, dice calculations, encounter budgets, and selected monster reference records from the SRD; it does not include the complete SRD text or a complete rules database.
