...
- Preserve Back/long-Back navigation conventions consistently across companion FAPs: Short Back moves up one screen and, from the companion main screen, returns to DNDolphins when installed with focus restored to that companion's corresponding DNDolphins menu row; Hold Back exits to firmware without a handoff.
