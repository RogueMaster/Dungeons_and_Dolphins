...
| RogueMaster branch 420 | Compiler verified | Commit and API level are recorded in `BUILD_VERIFICATION.md` |
...
| SD card present | Required for persistence | Bundled assets install with the FAP; character data uses app-data storage |
...
The source-only release does not bundle a compiled FAP. Build it with the firmware revision recorded in `BUILD_VERIFICATION.md`.
