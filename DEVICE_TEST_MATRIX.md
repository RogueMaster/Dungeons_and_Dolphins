...
| MEM-02 | Largest data | Repeatedly page through the largest spell/item catalogs and the 340-monster browser in 50-record windows. | No out-of-memory error, reboot, frozen input, or progressive heap loss. | Pending hardware |
